...
export const articles = [
  ...
  {
    title: "股价与股民情绪是否有相关性？基于大模型来快速验证",
    date: "2024-04-18",
    description:
      "几年前就提出的假设，无奈难以实施，而现在大模型的出现让批量快速评估变得可行。",
    id: 8,
  },
  {
    title:
      "Tensorflow.js（四）：基于 node 使用长短期记忆网络进行文本分类",
    date: "2024-05-20",
    description:
      "本文将介绍如何使用长短期记忆网络（LSTM）进行文本分类任务，LSTM 是一种特殊的 RNN，能够学习长期依赖关系，适合处理时间序列数据。",
    id: 9,
  },
  {
    title: "浏览器的阅读模式：Readability 正文提取算法解析，简单实现与改进",
    date: "2024-07-31",
    description:
